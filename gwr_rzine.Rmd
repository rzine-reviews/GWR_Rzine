...
Ainsi que les autres données issues de l'INSEE :

```{r}
# vignettes avec toutes les variables
```
...
Comme il l'a été mentionné, on pourrait définir l'autocorrélation spatiale comme la corrélation, positive ou
...
- Dautre part, dans la définition du modèle statistique, la mesure de l'autocorrélation spatiale peut
...
<div class="alert alert-success" role="alert">
Le logiciel [GeoDa](http://geodacenter.github.io/) a été développé par Luc Anselin et son équipe notamment pour étudier l'autocorrélation spatiale et les LISA. C'est un très bon logiciel en clic-boutons, avec une [documentation](http://geodacenter.github.io/documentation.html) riche.
</div>
