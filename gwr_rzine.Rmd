...
mf_layout(
  title = var,
  credits = 'Sources: INSEE, IGN Admin Express',
  arrow = FALSE,
  scale = FALSE)
}
```
...
mf_map(x = data_immo, 
       ...
       leg_val_rnd = 1)
mf_layout(
  title = "Résidus de régression linéaire classique",
  credits = "Sources: Notaires de France, INSEE, IGN Admin Express",
  arrow = FALSE,
  scale = FALSE
)
...
mf_map(x = data_immo, 
       ...
       leg_val_rnd = 1)
mf_layout(
  title = "Carte des LISA du prix médian du logement (Moran local)",
  credits = "Sources: Notaires de France, INSEE, IGN Admin Express",
  arrow = FALSE,
  scale = FALSE
)
...
mf_layout(
  title = "Carte de significativité des LISA",
  credits = "Sources: Notaires de France, INSEE, IGN Admin Express",
  arrow = FALSE,
  scale = FALSE
)
...
```{r}
# par(mfrow = c(4, 2), heights = c(10, 10, 10, 10, 10, 10, 10, 10))
# par(mfrow = c(2, 2))
