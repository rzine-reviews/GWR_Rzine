...
knitr::include_graphics(here("public/figures", "modeles.png"))
```
...
<div class="alert alert-danger">
Ce serait bien de justifier ici pourquoi on utilise un noyau gaussien non ?
</div>
...
<div class="alert alert-danger">
Une petite conclusion ? Du style "ici, nous allons donc utiliser une bande passante de 19 voisins : pour chaque EPCI, les EPCI qui seront à une distance supérieure (en nombre de voisins donc) ne seront pas pris en compte dans le modèle." ??
</div>
