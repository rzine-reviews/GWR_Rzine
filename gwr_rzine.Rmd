...
Les individus statistiques, représentés par des unités spatiales ne peuvent pas être envisagées comme indépendantes et identiquement distribuées.
...
Ces méthodes ne sont pas l'objet de la présente fiche et nous renvoyons les lecteurs et lectrices à d'autres références ([@elhorst2014]).
...
- La structure de la dépendance spatiale peut également être sujette à discussion : on peut imaginer que chaque point de l'espace présente une structure de la dépendance différente et qu'il soit pertinent de redéfinir, pour chaque point de l'espace, une forme de noyau et une bande passante différente ([@comber2022]).
